...
Test(exec_redirection, redir_pipe_1)
{
    ...
    struct AST *ast_fd_to = new_AST(new_token(copy_string("file11.txt"), (enum token_type) WORD, false), 
    (enum AST_type) ARG, NULL);
    ...
    struct AST *ast_redirect2 = new_AST(new_token(copy_string(">"), (enum token_type) R_SUP, false), 
