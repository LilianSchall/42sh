...
int exec2(void)
{
    struct AST *ast_1 = new_AST(new_token(copy_string("hello"), (enum token_type) WORD, false), (enum AST_type) ARG, NULL);   
    struct AST *ast_2 = new_AST(new_token(copy_string("world!"), (enum token_type) WORD, false), (enum AST_type) ARG, NULL);
