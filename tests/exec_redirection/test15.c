...
Test(exec_redirection, redirection_15, .init = redirect_15)
{
    ...
    struct AST *ast_fd_to = new_AST(new_token(copy_string("test15_e.txt"), (enum token_type) WORD, false), 
    (enum AST_type) ARG, NULL);
    ...
    struct AST *ast_redirect = new_AST(new_token(copy_string(">|"), (enum token_type) R_SUP_PIPE, false), 
    ...
    struct AST *ast_fd_to2 = new_AST(new_token(copy_string("test15_v.txt"), (enum token_type) WORD, false), 
    (enum AST_type) ARG, NULL);
